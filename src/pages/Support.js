            ...
            <div className="pt-32 pb-12 md:pt-32 md:pb-20">
              ...
              <form className="max-w-xl mx-auto" ref={form} onSubmit={sendEmail}>
                ...
                <div className="flex flex-wrap -mx-3 mt-4">
                  <div className="w-full px-3">
                    <button loading type="submit" className="btn text-white bg-teal-50 hover:bg-yellow-50 w-full">Send</button>
                  </div>
                </div>
                <div className="text-sm text-gray-600 mt-4">
                  By clicking "send" you consent to allow Audiotrocities to store and process the personal information submitted above and agree to our <a className="underline" target="_blank" rel="noopener noreferrer" href={terms}>terms and conditions</a> as well as our <a className="underline" href="#0">Privacy Policy</a>.
                </div>
              </form>
            </div>
          </div>
