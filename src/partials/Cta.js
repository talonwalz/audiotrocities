          ...
          <div className="bg-teal-50 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl" data-aos="zoom-y-out">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
                <h3 className="h3 text-white mb-2">Ready to give Audiomojis a try?</h3>
              </div>

              {/* CTA button */}
              <div >
              <a className="appstorebtn w-full h-8 my-4 sm:w-auto sm:mb-0" href="https://apps.apple.com/us/app/spotify-new-music-and-podcasts/id324684580?itsct=apps_box_badge&amp;itscg=30200" target="_blank" rel="noreferrer">
