        ...
        <div className="grid sm:grid-cols-2 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="text-sm text-gray-600">
              <a className='text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out' target="_blank" rel="noopener noreferrer" href={terms}>Terms</a> · <Link to="#" className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Privacy Policy</Link>
            </div>
          </div>
          ...
          {/* <div className="sm:col-span-6 md:col-span-3 lg:col-span-4">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Audiomojis</Link>
              </li>
              <li className="mb-2">
          ...
          {/* 3rd block */}
          <div className="lg:m-auto sm:ml-0 sm:col-span-2 md:col-span-2 lg:col-span-1">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            ...
            <li className="ml-4">
              ...
              <svg className="w-8 h-8 relative top-2 left-2 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
